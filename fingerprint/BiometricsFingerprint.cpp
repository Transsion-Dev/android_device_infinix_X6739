...
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.3-service.transsion"
...
#define FOD_HBM_PATH "/sys/kernel/tran_display/lcm_hbm_state"
...
BiometricsFingerprint::BiometricsFingerprint() : mClientCallback(nullptr), mGoodixFingerprintDaemon(nullptr), mDevice(nullptr) {
...
fingerprint_device_t* BiometricsFingerprint::openHal() {
    ...
    if (0 != (err = hw_get_module_by_class("gf_fingerprint", "goodix", &hw_mdl))) {
